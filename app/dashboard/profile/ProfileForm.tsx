    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="pt-4 flex justify-end gap-3">
        <button
          ...
          onClick={() => router.back()}
          disabled={isPending}
          className="btn-outline px-8 py-3 w-full sm:w-auto text-navy border-navy/20 hover:bg-navy/5"
        >
          Kembali
        </button>
        <button
          type="submit"
          disabled={isPending}
          className={`btn-primary px-8 py-3 w-full sm:w-auto ${isPending ? "opacity-70" : ""}`}
        >
